...
CREATE TABLE tbcampanhaportabela (
  idCampanha INTEGER NOT NULL,
  idTabela INTEGER NOT NULL,
...
CREATE TABLE tbsitiotemp (
  ...
  lng FLOAT,
  descricao varchar(200),
  idSitio_anterior INTEGER NOT NULL,
  idReservatorio_anterior INTEGER NOT NULL,
  PRIMARY KEY (idSitio),
  CONSTRAINT tbSitio_sitiofk FOREIGN KEY (idReservatorio) REFERENCES tbreservatorio (idReservatorio) ON DELETE NO ACTION ON UPDATE CASCADE
);

CREATE TABLE tbabioticocoluna (
...
CREATE TABLE tbabioticosuperficie (
...
CREATE TABLE tbaguamateriaorganicasedimento (
...
CREATE TABLE tbbioticosuperficie (
...
CREATE TABLE tbconcentracaogasagua (
...
CREATE TABLE tbconcentracaogassedimento (
...
CREATE TABLE tbdupladessorcaoagua (
...
CREATE TABLE tbfluxobolhasinpe (
...
CREATE TABLE tbfluxodifusivoinpe (
...
CREATE TABLE tbionsnaaguaintersticialdosedimento (
...
CREATE TABLE tbmedidacampocoluna (
...
CREATE TABLE tbmedidacamposuperficie (
...
CREATE TABLE tbnutrientessedimento (
...
CREATE TABLE tbparametrosbiologicosfisicosagua (
...
CREATE TABLE tbvariaveisfisicasquimicasdaagua (
